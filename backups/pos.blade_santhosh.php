        ...
        <div class="row m-0">
            ...
            <div class="col-md-6 ">
                <div class="">
                    ...
                    {!! Form::open(['route' => 'sales.store','name'=>'salesForm', 'method' => 'post', 'files' => true, 'class' => 'payment-form']) !!}
                        @php
                            if($lims_pos_setting_data)
                                $keybord_active = $lims_pos_setting_data->keybord_active;
                            else
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="sales_person_code" class="form-control" onkeyup='saveValue(this);'  placeholder="Type sales person code.." required>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                    ...
                    <div class="payment-options">
                        ...
                        <div class="column-5">
                            <button style="background-color: #b33771" type="button" class="btn btn-custom payment-btn" data-toggle="modal" data-target="#add-payment" id="upi-btn"><i class="fa fa-university"></i> {{trans('file.UPI')}}</button>
                        </div>
                        <!-- @if($lims_reward_point_setting_data->is_active)
                        <div class="column-5">
                        ...
                        <!-- <div class="column-5">
                            <button style="background-color: #F7A733;" type="button" class="btn btn-custom" data-toggle="modal" data-target="#recentTransaction"><i class="dripicons-clock"></i> {{trans('file.Recent transaction')}}</button>
                        </div> -->
                    </div>
                </div>
            </div>
                      ...
                      <div class="container-fluid">
                        <div class="navbar-holder d-flex align-items-center justify-content-between">
                          ...
                          <ul class="nav-menu list-unstyled d-flex flex-md-row align-items-md-center">
                            ...
                            @endif
                            <li class="nav-item">
                                <a class="dropdown-item" data-toggle="tooltip" title="{{trans('file.Help')}}" href="{{ url('public/read_me') }}" target="_blank"><i class="dripicons-information"></i></a>
                            </li>&nbsp;
                            <li class="nav-item">
                                  <a rel="nofollow" data-target="#" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link dropdown-item"><i class="dripicons-user"></i> <span>{{ucfirst(Auth::user()->name)}}</span> <i class="fa fa-angle-down"></i>
                                  </a>
