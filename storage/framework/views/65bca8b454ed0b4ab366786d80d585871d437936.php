    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-header mt-2">
                <h3 class="text-center"><?php echo e(trans('file.Expense List')); ?></h3>
            </div>
            <?php echo Form::open(['route' => 'expenses.index', 'method' => 'get']); ?>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\lnmedra\resources\views/expense/index.blade.php ENDPATH**/ ?>