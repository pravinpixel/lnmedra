                        ...
                        <form id="product-form">
                            ...
                            <div class="row">
                                        ...
                                        <table id="myTable" class="table table-hover order-list">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <input type="hidden" class="variant-id" name="variant_id[]" value="<?php echo e($variant_list[$key]); ?>"/>
                                                </tr>
                                ...
                                <div class="col-md-12 mt-3" id="batch-option">
                                    <?php if($lims_product_data->is_batch): ?>
                                    <h5><input name="is_batch" type="checkbox" id="is-batch" value="1" checked>&nbsp; <?php echo e(trans('file.This product has batch and expired date')); ?></h5>
                                    <?php else: ?>
                                ...
                                <div class="col-md-12 mt-3" id="imei-option">
                                    <?php if($lims_product_data->is_imei): ?>
                                    <h5><input name="is_imei" type="checkbox" id="is-imei" value="1" checked>&nbsp; <?php echo e(trans('file.This product has IMEI or Serial numbers')); ?></h5>
                                    <?php else: ?>
                                    <h5><input name="is_imei" type="checkbox" id="is-imei" value="1">&nbsp; <?php echo e(trans('file.This product has IMEI or Serial numbers')); ?></h5>
                                    <?php endif; ?>
                                </div>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\lnmedra\resources\views/product/edit.blade.php ENDPATH**/ ?>