        ...
        <div class="side-navbar-wrapper">
          ...
          <div class="main-menu">
            <ul id="side-main-menu" class="side-menu list-unstyled">
              ...
              ?>
              <?php if($store_outlet_permission_active || $outlet_setup_active || $user_management_active): ?>
              <li><a href="#store_outlet" aria-expanded="false" data-toggle="collapse"> <i class="dripicons-list"></i><span><?php echo e(__('file.store_outlet_management')); ?></span><span></a>
                <ul id="store_outlet" class="collapse list-unstyled ">
                  <?php if($outlet_setup_active): ?>
                  <li id="category-menu"><a href="<?php echo e(route('category.index')); ?>"><?php echo e(__('file.outlet_setup')); ?></a></li>
                  <?php endif; ?>
                  <?php if($user_management_active): ?>
                  <li id="printBarcode-menu"><a href="<?php echo e(route('product.printBarcode')); ?>"><?php echo e(__('file.user_management')); ?></a></li>
                  <?php endif; ?>
              ...
              ?>
              <?php if($enquiry_management_permission_active || $add_enquiry_permission_active): ?>
                <?php if($enquiry_management_permission_active): ?>
                <li><a href="#enquiry_management" aria-expanded="false" data-toggle="collapse"> <i class="dripicons-list"></i><span><?php echo e(__('file.enquiry_management')); ?></span><span></a>
                <?php endif; ?>
                <ul id="enquiry_management" class="collapse list-unstyled ">
                  <?php if($add_enquiry_permission_active): ?>
                  <li id="category-menu"><a href="<?php echo e(route('category.index')); ?>"><?php echo e(__('file.add_enquiry')); ?></a></li>
                  <?php endif; ?>
                  <li id="category-menu"><a href="<?php echo e(route('category.index')); ?>"><?php echo e(__('file.enquiry_list')); ?></a></li>
                </ul>
              </li>
              <?php endif; ?>
              <?php
                  ...
                  $vendor_login_permission = DB::table('permissions')->where('name', 'store-outlet-index')->first();
                  $vendor_login_permission_active = DB::table('role_has_permissions')->where([
                      ['permission_id', $vendor_login_permission->id],
                      ['role_id', $role->id]
                  ])->first();
              ?>
              <?php if($vendor_login_permission_active): ?>
                <?php if($outlet_setup_active): ?>
                <li><a href="#vendor_login" aria-expanded="false" data-toggle="collapse"> <i class="dripicons-list"></i><span><?php echo e(__('file.vendor_login')); ?></span><span></a>
                <?php endif; ?>
                <ul id="vendor_login" class="collapse list-unstyled ">
                  <li id="category-menu"><a href="<?php echo e(route('category.index')); ?>"><?php echo e(__('file.secure_login')); ?></a></li>
                  <li id="category-menu"><a href="<?php echo e(route('category.index')); ?>"><?php echo e(__('file.provision_manage_the_products')); ?></a></li>
                  <li id="printBarcode-menu"><a href="<?php echo e(route('product.printBarcode')); ?>"><?php echo e(__('file.details_of_product_Image')); ?></a></li>
          ...
          <div class="container-fluid">
            <div class="navbar-holder d-flex align-items-center justify-content-between">
              ...
              <span class="brand-big">
                ...
                <a href="<?php echo e(url('/')); ?>"><img src="<?php echo e(url('public/logo', $general_setting->site_logo)); ?>" width="115"></a>
                <?php else: ?>
              ...
              <ul class="nav-menu list-unstyled d-flex flex-md-row align-items-md-center">
                ...
                <?php if($product_qty_alert_active): ?>
                  ...
                  <li class="nav-item" id="notification-icon">
                        <a rel="nofollow" data-toggle="tooltip" title="<?php echo e(__('Notifications')); ?>" class="nav-link dropdown-item"><i class="dripicons-bell"></i><span class="badge badge-danger notification-number"><?php echo e(count(\Auth::user()->unreadNotifications)); ?></span>
                        </a>
                        <ul class="right-sidebar">
                            <?php $__currentLoopData = \Auth::user()->unreadNotifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li class="notifications">
               ...
               <?php if(Auth::user()->role_id != 5): ?>
                <!--<li class="nav-item">
                    <a class="dropdown-item" href="<?php echo e(url('public/read_me')); ?>" target="_blank" data-toggle="tooltip" title="<?php echo e(__('Help')); ?>"><i class="dripicons-information"></i></a>
                </li>-->
                <?php endif; ?>
                <li class="nav-item">
...
<?php /**PATH D:\xampp\htdocs\lnmedra\resources\views/layout/main.blade.php ENDPATH**/ ?>