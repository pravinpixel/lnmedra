        ...
        <div class="card">
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-4 mt-3 <?php if(\Auth::user()->role_id > 2): ?><?php echo e('d-none'); ?><?php endif; ?>">
                    <div class="d-flex">
                        <label class=""><?php echo e(trans('file.Warehouse')); ?> &nbsp;</label>
                        <div class="">
    ...
    function saleDetails(sale){
        ...
        $.get('sales/product_sale/' + sale[13], function(data){
            ...
            if(sale[28]) {
                var newRow = $("<tr>");
                cols = '';
                cols += '<td colspan=8><strong><?php echo e(trans("file.Coupon Discount")); ?> ['+sale[28]+']:</strong></td>';
                cols += '<td>' + sale[29] + '</td>';
                newRow.append(cols);
                newBody.append(newRow);
            }
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\lnmedra\resources\views/sale/index.blade.php ENDPATH**/ ?>