						                ...
						                <span>
						                    <div aria-checked="false" aria-disabled="false">
								                <div class="checkbox">
							                    	...
							                    	<?php endif; ?>
								                    <label for="reward_point_setting" class="padding05"><?php echo e(trans('file.Reward Point Setting')); ?> &nbsp;&nbsp;</label>
								                </div>
								            </div>
						                </span>
						            </td>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\salepro\resources\views/role/permission.blade.php ENDPATH**/ ?>