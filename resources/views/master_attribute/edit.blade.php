            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header d-flex align-items-center">
                        <h4>{{trans('file.edit_attribute')}}</h4>
                    </div>
                    <div class="card-body">
                        <p class="italic"><small>{{trans('file.The field labels marked with * are required input fields')}}.</small></p>
                        {!! Form::open(['route' => ['master-attribute.update',$data->id],'name'=>'master_attribute', 'method' => 'put', 'files' => true, 'id' => 'master_attribute']) !!}
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>{{trans('file.Title')}} *</strong> </label>
                                        <input type="text" name="title" class="form-control" value="{{ $data['title'] }}" id="title"  required>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>{{trans('file.Shorting')}} *</strong> </label>
                                        <input type="text" name="shorting" class="form-control"  value="{{ $data['shorting'] }}" id="shorting" required>
                                        <span class="validation-msg" id="shorting-error"></span>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <select name="product_type" required class="selectpicker form-control" data-live-search="true" title="Select Product Type...">
                                                @foreach($product_type as $product_type)
                                                    <option value="{{$product_type->id}}" <?php echo "{{$product_type->id}}" == "{{$data['product_type']}}" ?   "selected" : '' ;?>>{{$product_type->name}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>{{trans('file.Attribute Image')}}</strong> </label> <i class="dripicons-question" data-toggle="tooltip" title="{{trans('file.You can upload multiple image. Only .jpeg, .jpg, .png, .gif file can be uploaded. First image will be base image.')}}"></i>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                    <img src="{{asset('public/images/attribute/'.$data->image)}}" height="80px;" width:"80px;">
                                    </div>
                                </div>
