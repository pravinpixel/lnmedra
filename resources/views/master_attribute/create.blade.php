            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header d-flex align-items-center">
                        <h4>{{trans('file.add_attribute')}}</h4>
                    </div>
                    <div class="card-body">
                        <p class="italic"><small>{{trans('file.The field labels marked with * are required input fields')}}.</small></p>
                        {!! Form::open(['route' => 'master-attribute.store','name'=>'master_attribute', 'method' => 'post', 'files' => true, 'id' => 'master_attribute']) !!}
                            <div class="row">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                                ...
                                                <input type="text" name="shorting" value="{{old('shorting')}}" required class="form-control">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <select name="product_type"  value="{{old('product_type')}}" required class="selectpicker form-control" data-live-search="true" title="Select Product Type...">
