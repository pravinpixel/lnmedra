            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header d-flex align-items-center">
                        <h4>{{trans('file.add_accounts')}}</h4>
                    </div>
                    <div class="card-body">
                        <p class="italic"><small>{{trans('file.The field labels marked with * are required input fields')}}.</small></p>
                        {!! Form::open(['route' => 'accounts-date.store','name'=>'accounts_date', 'method' => 'post', 'files' => true, 'id' => 'accounts_date']) !!}
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>{{trans('file.Accounts Head Name')}} *</strong> </label>
                                        <input type="text" name="accounts_date_name" value="{{old('accounts_date_name')}}" class="form-control" id="accounts_date_name"  required>
                                        <span class="validation-msg" id="accounts_date_name-error"></span>
                                    </div>
                                    @if($errors->has('accounts_date_name'))
                                        <span>
                                            <strong style="color: red;" >{{ $errors->first('accounts_date_name') }}</strong>
                                        </span>
                                    @endif
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                                ...
                                                <label>{{trans('file.Allocated')}} % *</strong> </label>
                                                <input type="number" name="percentage" value="{{old('percentage')}}" required class="form-control">
                                                <span class="validation-msg" id="percentage-error"></span>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                                ...
                                                <label>{{trans('file.description')}} *</strong> </label>
...
$("ul#setting").siblings('a').attr('aria-expanded','true');
    ...
    $("ul#setting #accounts-date-menu").addClass("active");
