            ...
            <div class="col-md-6 ">
                <div class="">
                    ...
                    <div class="payment-optionsx">
                        <div class="column-5">
                            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#add-payment" id="credit-card-btn"><i class="fa fa-credit-card"></i> <b>{{trans('file.Card')}}</b></button>
                        </div>
                        <div class="column-5">
                            <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#add-payment" id="cash-btn"><i class="fa fa-money"></i> <b>{{trans('file.Cash')}}</b></button>
                        </div>
                        <div class="column-5">
                            <button type="button" class="btn btn-info" data-toggle="modal" data-target="#add-payment" id="paypal-btn"><i class="fa fa-paypal"></i> <b>UPI</b></button>
                        </div> 
