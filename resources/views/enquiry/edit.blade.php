                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <select name="requirement" class="selectpicker form-control @error('type') is-invalid @enderror" value="{{old('requirement')}}"  autocomplete="type" data-live-search="true" data-live-search-style="begins"  required>
                                                    ...
                                                    <option value="2" <?php echo "$lims_enquiry_data->requirement" == "2" ?   "selected" : '' ;?> >Landscape execution</option>
                                                    <option value="3" <?php echo "$lims_enquiry_data->requirement" == "3" ?   "selected" : '' ;?> >Retail sale</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
